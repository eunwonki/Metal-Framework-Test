...
class Node {
    ...
    private var _position: SIMD3<Float> = SIMD3<Float>()
    private var _scale: SIMD3<Float> = SIMD3<Float>(1,1,1)
    private var _rotation: SIMD3<Float> = SIMD3<Float>()
...
extension Node {
    ...
    func setPosition(_ r: Float,_ g: Float,_ b: Float) { setPosition(SIMD3<Float>(r,g,b)) }
    ...
    func setRotation(_ r: Float,_ g: Float,_ b: Float) { setRotation(SIMD3<Float>(r,g,b)) }
    ...
    func setScale(_ r: Float,_ g: Float,_ b: Float) { setScale(SIMD3<Float>(r,g,b)) }
